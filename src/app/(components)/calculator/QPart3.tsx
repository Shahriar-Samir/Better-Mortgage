    ...
    return (
        <section className='w-11/12 mx-auto max-w-[1200px]'>
            ...
            <article className='py-10 border-t border-b border-gray-300'>
                ...
                <p className=''>There are 8 steps to buying a house and by using this calculator you&apos;ve completed step 2 &lpar;calculating your home affordability&rpar; and maybe even step 1 &lpar;getting your finances in order&rpar;.</p><br></br>
