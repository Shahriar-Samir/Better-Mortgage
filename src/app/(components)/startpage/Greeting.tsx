        ...
        <section className='flex justify-center items-center mt-20 flex-col w-full max-w-[550px] mx-auto'>
                ...
                <div className='flex items-center justify-center gap-8 mt-16'>
                        <div className='flex flex-col items-center'>
                            ...
                            <p className='text-sm font-myFont3 text-gray-500 mt-4'>home loans funded entirely online</p>
                        </div>
                        <div className='flex flex-col items-center'>
                            <h1 className='font-myFont5 text-3xl'>400K</h1>
                            <p className='text-sm font-myFont3 text-gray-500 mt-4'>Customers who chose a Better Mortgage</p>
                        </div>
                </div>
